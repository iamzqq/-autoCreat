...
let actionMap = {
    ...
    create: {
        ...
        usages: [// 使用方法
        'lsn-cli create ProjectName', 'lsn create ProjectName'],
        alias: 'c' // 命令简称
    },
    // 项目初始化
    init: {
        description: '初始化项目',
        usages: ['lsn-cli init', 'lsn init'],
        alias: 'i'
    },
    // 启动项目
    dev: {
        description: '本地启动项目',
        usages: ['lsn-cli dev', 'lsn dev'],
        options: [{
            flags: '-p --port <port>',
            description: '端口',
            defaultValue: 3000
    ...
    build: {
        description: '服务端项目打包',
        usages: ['lsn-cli build', 'lsn build'],
        options: [{
